...
const formSchema = z.object({
  ...
  parkingSpots: z.array(z.string().min(1, "Parking spot identifier cannot be empty")).default([]),
  storageLockers: z.array(z.string().min(1, "Storage locker identifier cannot be empty")).default([]),
  bikeLockers: z.array(z.string().min(1, "Bike locker identifier cannot be empty")).default([]),
