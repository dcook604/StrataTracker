...
--
-- Name: migration_history; Type: TABLE; Schema: public; Owner: spectrum4
--
...
ALTER TABLE public.migration_history OWNER TO spectrum4;

--
-- Name: migration_history_id_seq; Type: SEQUENCE; Schema: public; Owner: spectrum4
--
...
ALTER SEQUENCE public.migration_history_id_seq OWNER TO spectrum4;

--
-- Name: migration_history_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: spectrum4
--
...
--
-- Name: migration_history id; Type: DEFAULT; Schema: public; Owner: spectrum4
--
...
--
-- Data for Name: migration_history; Type: TABLE DATA; Schema: public; Owner: spectrum4
--

COPY public.migration_history (id, filename, applied_at) FROM stdin;
\.
...
--
-- Name: migration_history_id_seq; Type: SEQUENCE SET; Schema: public; Owner: spectrum4
--
...
--
-- Name: migration_history migration_history_filename_key; Type: CONSTRAINT; Schema: public; Owner: spectrum4
--

ALTER TABLE ONLY public.migration_history
    ADD CONSTRAINT migration_history_filename_key UNIQUE (filename);


--
-- Name: migration_history migration_history_pkey; Type: CONSTRAINT; Schema: public; Owner: spectrum4
--
